...
public class ApiV1AiController {
    ...
    public RsData<Object> generate(@RequestBody @Validated AiGenerateReqBody req) {
        return RsData.successOf(aiGenerateService.generate(req));
    }

    @PostMapping(value = "/chat", produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "챗봇 (단일 응답)")
    public RsData<String> chatOnce(@RequestBody @Validated AiChatReqBody req) {
    ...
    public RsData<String> chatWithRag(@RequestBody @Validated AiChatReqBody req) {
